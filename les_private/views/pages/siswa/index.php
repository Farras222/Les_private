...
function siswa_auth() {
    ...
    $query = "SELECT id FROM user WHERE id = '{$_SESSION['user_id']}' AND role = 'siswa'";
...
$siswa_query = "SELECT * FROM user WHERE id = '$siswa_id'";
$siswa = mysqli_fetch_assoc(mysqli_query($mysqli, $siswa_query));
