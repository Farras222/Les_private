...
FROM courses
JOIN user users ON users.id = courses.guru_id
";
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Courses Data (<?php echo $total_data; ?>)</h6>
                        <a href="tambah.php" class="btn btn-info btn-sm btn-action bg-warning">
                            <i class="fas fa-edit"></i> Tambah Course
                        </a>
                    </div>
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <thead>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Teachers</th>
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                    <h6 class="mb-0 text-sm"><?php echo $course['title']; ?></h6>
                                    <p class="text-xs text-secondary mb-0"><?php echo $course['description']; ?></p>
                                </div>
                                </div>
                            </td>
                            <td>
                                 <p class="text-xs font-weight-bold mb-0"><?php echo $course['guru_name']; ?></p>
                            </td>
                            <td class="align-middle">
                                <a href="edit.php?id=<?php echo $course['id']; ?>" class="btn btn-info btn-sm btn-action bg-success">
                                    Edit
                                </a>
                                <a href="delete.php?id=<?php echo $course['id']; ?>" class="btn btn-info btn-sm btn-action bg-danger"  onclick="return confirm('Yakin hapus course <?php echo addslashes($course['title']); ?>?')">
                                    Delete
                                </a>
                            </td>
                            </tr>
                        ...
                        <?php else: ?>
                            ...
                            <div class="text-center py-5">
                                ...
                                <h4 class="text-dark mb-2">Tidak Ada Data Course</h4>
                                <p class="text-muted mb-3">Belum ada data course yang terdaftar di sistem.</p>
