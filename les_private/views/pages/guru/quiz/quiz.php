...
$result_courses = mysqli_query($mysqli, $query_courses);
...
$result_materials = mysqli_query($mysqli, $query_materials);
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Quiz Data (<?php echo $total_data; ?>)</h6>
                        <a href="tambah.php" class="btn btn-info btn-sm btn-action bg-warning">
                            <i class="fas fa-edit"></i> Tambah Quiz
                        </a>
                    </div>
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                    <h6 class="mb-0 text-sm"><?php echo $quiz['title']; ?></h6>
                                    <p class="text-xs text-secondary mb-0"><?php echo $quiz['type']; ?></p>
                                </div>
                                </div>
                            </td>
                            <td>
                                 <p class="text-xs font-weight-bold mb-0"><?php echo $courses[$quiz['course_id']]; ?></p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                    <?php 
                                if($quiz['material_id'] == 0){
                                    echo "<p class='text-xs font-weight-bold mb-0'>Tidak ada</p>";
                                }else{
                                    echo "<p class='text-xs font-weight-bold mb-0'>".$materials[$quiz['material_id']]."</p>";
                                } 
                                ?>
                            </td>
                            <td class="align-middle text-center">
                                <span class="text-secondary text-xs font-weight-bold"><?php echo $quiz['passing_score']; ?></span>
                            </td>   
                            <td class="align-middle">
                                <a href="delete.php?id=<?php echo $quiz['id']; ?>" class="btn btn-info btn-sm btn-action bg-danger"  onclick="return confirm('Yakin hapus user <?php echo addslashes($quiz['title']); ?>?')">
                                    Delete
                                </a>
                            </td>
                            </tr>
                        ...
                        <?php else: ?>
                            ...
                            <div class="text-center py-5">
                                ...
                                <h4 class="text-dark mb-2">Tidak Ada Data Quiz</h4>
                                <p class="text-muted mb-3">Belum ada data quiz yang terdaftar di sistem.</p>
