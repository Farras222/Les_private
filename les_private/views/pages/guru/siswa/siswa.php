...
$count_query = "SELECT COUNT(*) as total FROM user WHERE role = 'siswa'";
if (!empty($search)) {
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Students Data (<?php echo $total_data; ?>)</h6>
                        <a href="tambah.php" class="btn btn-info btn-sm btn-action bg-warning">
                            <i class="fas fa-edit"></i> Tambah Student
                        </a>
                    </div>
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <?php else: ?>
                            ...
                            <div class="text-center py-5">
                                ...
                                <h4 class="text-dark mb-2">Tidak Ada Data Student</h4>
                                <p class="text-muted mb-3">Belum ada data student yang terdaftar di sistem.</p>
                                <a href="tambah.php" class="btn btn-warning">
                                    <i class="fas fa-plus me-2"></i> Tambah Student
                                </a>
                            </div>
                        <?php endif; ?>
                    </div>
