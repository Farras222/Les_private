...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare("UPDATE user SET name = ?, email = ?, password = ?, no_hp = ?, alamat = ? WHERE id = ?");
    $stmt->bind_param("sssssi", $name, $email, $password, $phone, $alamat, $user_id);

    if ($stmt->execute()) {
        $_SESSION['success'] = "Siswa berhasil diupdate!";
    } else {
