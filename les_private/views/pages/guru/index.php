...
function guru_auth() {
    ...
    $query = "SELECT id FROM user WHERE id = '{$_SESSION['user_id']}' AND role = 'guru'";
...
$guru_query = "SELECT * FROM user WHERE id = '$guru_id'";
$guru = mysqli_fetch_assoc(mysqli_query($mysqli, $guru_query));
